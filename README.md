...
Add screenshots of the server and client GUI in the `screenshots/` folder and reference them here.

## Learning Outcomes

- Practical experience with TCP sockets and streams
- Multi-threading patterns for networked applications
- Building simple desktop GUIs with Swing and AWT

## Contribution & Notes

If you modify the project structure, please update the instructions above accordingly. If you want, I can also:

- Reorganize code into the suggested `client`/`server` packages
- Add comments and inline documentation to `Server.java` and `Client.java`
- Create a simple script or Gradle build file for compiling and running

---

If this README looks good, commit it and push it. I have included the main sections you asked for and a clear run guide. 

*Generated/edited on request to be directly added to the repository.*
